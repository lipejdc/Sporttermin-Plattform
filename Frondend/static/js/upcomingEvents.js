...
// Funktion, um zu überprüfen, ob das Datum in der Zukunft liegt
...
// Funktion, um zukünftige Veranstaltungen auf der Webseite anzuzeigen
function showFutureEvents() {
    var events = document.querySelectorAll('.event-details');
    events.forEach(function (event) {
        var dateElement = event.querySelector('.event-date');
